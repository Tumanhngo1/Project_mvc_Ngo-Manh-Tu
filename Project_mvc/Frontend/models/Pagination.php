...
//        index.php?controller=&action=&id=&page=3
  ...
  public function getPrevPage() {
    ...
    if ($current_page >= 2) {
      ...
      $page = $current_page - 1;
      $prev_url =
        "index.php?controller=$controller&action=$action&page=$page&id=$id";
    ...
    if ($full_mode == FALSE) {
      for ($page = 1; $page <= $total_page; $page++) {
        ...
        if ($page == 1 || $page == $total_page || $page  == $current_page - 1 || $page == $current_page + 1) {
          $page_url = "index.php?controller=$controller&action=$action&page=$page&id=$id";
