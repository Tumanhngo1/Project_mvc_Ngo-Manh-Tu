                        ...
                        <div class="input-title">
                            <form method="GET" action="">
                                <input type="text" name="title" class=" form-control" placeholder="Tìm kiếm"
                                    value="<?php echo isset($_GET['title2']) ? $_GET['title2'] : '' ?>">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="input-title">
                            ...
                            <ul>
                                <li><i class="fa-solid fa-stop"></i></li>
                                <li><a
                                        href="index.php?controll=product&action=clothing&price=<?php echo $price['rangeprice'];?>"><?php echo $price['rangeprice'];?></a>
                                </li>
                            </ul>
                            <?php endforeach;?>
                        </div>
                ...
                <div class="categories">
                    ...
                    <div class="details">
                        <div class="detail">
                            ...
                            <div class="card col-xs-12 col-md-6 col-sm-3 col-lg-3">

                                <div class="card_img">
                                    <?php if(!empty($clothing['avatars'])):?>
                                    ...
                                    <div class="card_action">
                                        ...
                                        <div class="card_right product_title" 
                                            data_id="<?php echo $clothing['id']?>"><a href="index.php?controller=cart&action=index"><i
                                                    class="fa-solid fa-cart-shopping"></i></a></div>
                                    </div>
                                </div>
                                <div class="card_title">
                                    <?php echo $clothing['title'];?>
                                </div>
                                <div class="card_price">
                                    <?php $price = '';
                                if ($clothing['price_sale'] > 0) :
                                ?>
                                    <div class="price"><?php echo number_format($clothing['price_sale']) ;?>đ</div>
                                    <div class="sale"><?php echo number_format($clothing['price']) ;?>đ</div>
                                    <?php else:?>
                                    <div class="price"><?php echo number_format($clothing['price']) ;?>đ</div>
                                    <?php endif ;?>
                                </div>
