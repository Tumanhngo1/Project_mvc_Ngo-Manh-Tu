                    ...
                    <div class="sidebar">
                        ...
                        <div class="input-title">
                            ...
                            <ul>
                                <li><i class="fa-solid fa-stop"></i></li>
                                <li><a
                                        href="index.php?controll=product&action=sale&price=<?php echo $price['rangeprice'];?>"><?php echo $price['rangeprice'];?></a>
                                </li>
                            </ul>
                            <?php endforeach;?>
                        </div>
                    ...
                    <div class="details">
                        ...
                        <?php foreach($sales as $sale):?>
                            <div class="card col-md-6 col-sm-3 col-lg-3">
                                ...
                                <div class="card_img">
                                    <?php if(!empty($sale['avatars'])):?>
                                    <img src="../Backend/assets/uploads/<?php echo $sale['avatars']?>">
                                    <?php endif;?>
                                    <div class="card_action">
                                        <div class="card_left" 
                                            > <a
                                                href="index.php?controller=product&action=detail&id=<?php echo $sale['id'] ;?>"><i
                                                    class="fa-solid fa-eye"></i></a></div>
                                        <div class="card_right product_title"
                                            data_id="<?php echo $sale['id']?>"><a href="index.php?controller=cart&action=index"><i
                                ...
                                ?>
                                    <div class="price"><?php echo number_format($sale['price_sale']) ;?>đ</div>
                                    <div class="sale"><?php echo number_format($sale['price']) ;?>đ</div>
                                    <?php else:?>
